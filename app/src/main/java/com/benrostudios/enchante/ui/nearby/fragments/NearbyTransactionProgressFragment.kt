 ...
 * Use the [NearbyTransactionProgressFragment.newInstance] factory method to
...
class NearbyTransactionProgressFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NearbyTransactionProgressFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NearbyTransactionProgressFragment().apply {
